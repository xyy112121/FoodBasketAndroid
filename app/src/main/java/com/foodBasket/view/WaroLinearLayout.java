...
public class WaroLinearLayout extends ViewGroup {

    private Type mType;
    private List<WarpLine> mWarpLineGroup;

    public WaroLinearLayout(Context context) {
        this(context, null);
    }

    public WaroLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, R.style.WarpLinearLayoutDefault);
    }

    public WaroLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
