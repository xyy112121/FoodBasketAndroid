...
//    private BadgeView mTwoBadgeView;
    ...
    public void addTab(Class frameLayoutClass, TabParam tabParam) {
        int defaultLayout = R.layout.view_comui_tab;

        LinearLayout view = (LinearLayout) LayoutInflater.from(getContext()).inflate(defaultLayout, null);
...
//    }
    ...
    protected void onAttachedToWindow() {
        ...
        if (!(getContext() instanceof FragmentActivity)) {
            throw new RuntimeException("parent ui must is extends FragmentActivity");
        }
