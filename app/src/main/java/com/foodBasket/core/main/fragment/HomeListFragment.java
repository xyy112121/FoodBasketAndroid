...
public class HomeListFragment extends Fragment {
    ...
    private void initView() {
        mTypeAdapter = new TypeAdapter(getActivity(), R.layout.fragment_home_list_type_item);
    ...
    public class TypeAdapter extends ArrayAdapter<ResponseBean> {
        ...
        public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
            ViewHolder holder;
            if (convertView == null) {
                convertView = mInflater.inflate(R.layout.fragment_home_list_type_item, null);
